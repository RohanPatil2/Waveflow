...
var style_min = createCommonjsModule(function(module, exports) {
  !(function(e, o) {
    ...
    let o = { colorize: "C", colorhex: "(?:[0-9a-fA-F]{3}){1,2}", colorname: "[a-zA-Z]+", padding: "P[0-9]{2}", zoom: "Z(?:[0-9]+(?:\\.[0-9]+)?|x)", classbase: "-?[_a-zA-Z][_a-zA-Z0-9-]{0,100}", id: "[a-zA-Z][_a-zA-Z0-9-]{0,100}" };
    ...
    e.compose = (e2) => {
      ...
      return __spreadProps(__spreadValues(__spreadValues({}, e2), o2), { zoom: t2 * s2 });
    }, e.parse = (e2) => {
      const s2 = `^${o.full}`, a2 = ("string" == typeof e2 ? e2.match(new RegExp(s2)) : []) || [];
      return i = { colorize: a2[1] ? !!a2[1] : void 0, padding: a2[2] ? parseInt(a2[2].slice(1)) : void 0, background: a2[3] ? t(a2[3].slice(2, -1)) : void 0, detail: a2[4] ? a2[4].slice(2, -1).split(",").map(t) : void 0, zoom: a2[5] ? "Zx" === a2[5] ? "x" : parseFloat(a2[5].slice(1)) : void 0, detailsym: a2[6] ? a2[6].match(new RegExp(o.detailsym, "g")).map(((e3) => {
        const o2 = e3.split("_"), s3 = o2[1].split(",").map(t);
        return { index: parseInt(o2[0].slice(1)), detail: s3 };
      })) : void 0, classes: a2[7] ? a2[7] : void 0, id: a2[8] ? a2[8] : void 0 }, Object.fromEntries(Object.entries(i).filter((([e3, o2]) => void 0 !== o2)));
      var i;
...
//# sourceMappingURL=chunk-QDYT2HQG.js.map
