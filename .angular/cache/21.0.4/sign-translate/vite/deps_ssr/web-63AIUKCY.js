...
var FirebasePerformanceWeb = class _FirebasePerformanceWeb extends WebPlugin {
  ...
  putAttribute(_0) {
    return __async(this, arguments, function* ({ traceName, attribute, value }) {
  ...
  getAttribute(_0) {
    return __async(this, arguments, function* ({ traceName, attribute }) {
      var _a;
      const trace2 = this.traces[traceName];
      if (!trace2) {
        throw new Error(_FirebasePerformanceWeb.ERROR_TRACE_NOT_FOUND);
  ...
  getAttributes(_0) {
    return __async(this, arguments, function* ({ traceName }) {
      const trace2 = this.traces[traceName];
      if (!trace2) {
        throw new Error(_FirebasePerformanceWeb.ERROR_TRACE_NOT_FOUND);
      }
  ...
  putMetric(_0) {
    return __async(this, arguments, function* ({ traceName, metricName, num }) {
      const trace2 = this.traces[traceName];
      if (!trace2) {
        throw new Error(_FirebasePerformanceWeb.ERROR_TRACE_NOT_FOUND);
      }
  ...
  getMetric(_0) {
    return __async(this, arguments, function* ({ traceName, metricName }) {
      const trace2 = this.traces[traceName];
      if (!trace2) {
        throw new Error(_FirebasePerformanceWeb.ERROR_TRACE_NOT_FOUND);
      }
  ...
  record(_0) {
    return __async(this, arguments, function* ({ traceName, startTime, duration, options }) {
      const perf = getPerformance();
...
//# sourceMappingURL=web-63AIUKCY.js.map
