...
var X = z ? H : "L";
var Y = { L: { value: 0, configurable: true, writable: true, enumerable: false } };
...
function Jt(t2) {
  ...
  if (-1 !== (e2 = t2.indexOf(".")) && (t2 = t2.substring(0, e2)), e2 = t2.length, !("-" === t2[0] ? e2 < 20 || 20 === e2 && Number(t2.substring(0, 7)) > -922337 : e2 < 19 || 19 === e2 && Number(t2.substring(0, 6)) < 922337)) if (kt(t2), t2 = It, 2147483648 & (e2 = Tt)) if (rt()) t2 = "" + (BigInt(0 | e2) << BigInt(32) | BigInt(t2 >>> 0));
  else {
...
function me(t2, e2, n2, r2) {
  ...
  var s2 = t2.length - 1;
  return o2 >= s2 && 256 & e2 ? (t2[s2][n2] = r2, e2) : o2 <= s2 ? (t2[o2] = r2, 256 & e2 && (n2 in (t2 = t2[s2]) && delete t2[n2]), e2) : (void 0 !== r2 && (n2 >= (s2 = e2 >> 15 & 1023 || 536870912) ? null != r2 && (t2[s2 + i2] = { [n2]: r2 }, tt(t2, e2 |= 256)) : t2[o2] = r2), e2);
}
function ye(t2) {
  let e2 = 0 | (t2 = t2.l)[X];
...
function ze(t2) {
  if ("string" == typeof t2) return { buffer: O(t2), v: false };
  ...
  if (t2.constructor === j) return { buffer: V(t2) || new Uint8Array(0), v: true };
...
function Gr(t2) {
  void 0 === jr && (jr = (function() {
    ...
    try {
      const e3 = (t4) => t4;
      t3 = Cr.createPolicy("goog#html", { createHTML: e3, createScript: e3, createScriptURL: e3 });
    } catch (t4) {
    }
    return t3;
  })());
...
function xi(t2) {
  const e2 = { classifications: Ne(t2, ai).map(((t3) => (function(t4, e3 = -1, n2 = "") {
    return { categories: t4.map(((t5) => {
      var e4 = Wt(de(t5, 1)) ?? 0 ?? -1;
      const n3 = t5.l;
      let r2 = 0 | n3[X];
      const i2 = ge(n3, r2, 2), o2 = Dt(i2);
      return null != o2 && o2 !== i2 && me(n3, r2, 2, o2), { index: e4, score: o2 ?? 0 ?? 0, categoryName: Zt(de(t5, 3)) ?? "" ?? "", displayName: Zt(de(t5, 4)) ?? "" ?? "" };
...
function zi(t2, e2, n2) {
  return __async(this, null, function* () {
    ...
    }))(t2, e2.wasmLoaderPath, e2.assetLoaderPath, { locateFile: (t3) => t3.endsWith(".wasm") ? e2.wasmBinaryPath.toString() : e2.assetBinaryPath && t3.endsWith(".data") ? e2.assetBinaryPath.toString() : t3 }), yield t2.o(n2), t2;
  });
}
...
var Xi = class extends Ki {
  constructor(t2, e2) {
    super(new $i(t2, e2)), this.s = { languages: [] }, ke(t2 = this.i = new Si(), 0, 1, e2 = new wi());
  }
  o(t2) {
  ...
  u() {
    ...
    Ae(n2, Qt("mediapipe.tasks.text.text_classifier.TextClassifierGraph")), Yr(n2), Ge(n2, 4, "CLASSIFICATIONS:classifications_out"), n2.o(e2), Ce(t2, n2), this.g.attachProtoListener("classifications_out", ((t3, e3) => {
      if ({ classifications: t3 } = xi(ui(t3)), 1 !== t3.length) throw Error(`Expected 1 classification head, got ${t3.length}`);
      this.s.languages = t3[0].categories.map(((t4) => ({ languageCode: t4.categoryName, probability: t4.score }))), Ji(this, e3);
...
Xi.prototype.detect = Xi.prototype.J, Xi.prototype.setOptions = Xi.prototype.o, Xi.createFromModelPath = function(t2, e2) {
  return Ri(Xi, t2, { baseOptions: { modelAssetPath: e2 } });
}, Xi.createFromModelBuffer = function(t2, e2) {
  return Ri(Xi, t2, { baseOptions: { modelAssetBuffer: e2 } });
}, Xi.createFromOptions = function(t2, e2) {
  return Ri(Xi, t2, e2);
};
var Yi = class extends Ki {
  constructor(t2, e2) {
    super(new $i(t2, e2)), this.s = { classifications: [] }, ke(t2 = this.i = new Si(), 0, 1, e2 = new wi());
  }
  o(t2) {
    return ke(this.i, 0, 2, Ti(t2, Le(this.i, gi, 2))), Hi(this, t2);
  }
...
Yi.prototype.classify = Yi.prototype.I, Yi.prototype.setOptions = Yi.prototype.o, Yi.createFromModelPath = function(t2, e2) {
  return Ri(Yi, t2, { baseOptions: { modelAssetPath: e2 } });
}, Yi.createFromModelBuffer = function(t2, e2) {
  return Ri(Yi, t2, { baseOptions: { modelAssetBuffer: e2 } });
}, Yi.createFromOptions = function(t2, e2) {
  return Ri(Yi, t2, e2);
};
var Qi = class extends Ki {
  constructor(t2, e2) {
    super(new $i(t2, e2)), this.s = { embeddings: [] }, ke(t2 = this.i = new Ei(), 0, 1, e2 = new wi());
  }
  o(t2) {
  ...
  u() {
    ...
    Ae(n2, Qt("mediapipe.tasks.text.text_embedder.TextEmbedderGraph")), Yr(n2), Ge(n2, 4, "EMBEDDINGS:embeddings_out"), n2.o(e2), Ce(t2, n2), this.g.attachProtoListener("embeddings_out", ((t3, e3) => {
      t3 = di(t3), this.s = (function(t4) {
        return { embeddings: Ne(t4, hi).map(((t5) => {
          const e4 = { headIndex: Wt(de(t5, 3)) ?? 0 ?? -1, headName: Zt(de(t5, 4)) ?? "" ?? "" };
...
Qi.cosineSimilarity = function(t2, e2) {
  ...
  return Ri(Qi, t2, { baseOptions: { modelAssetPath: e2 } });
}, Qi.createFromModelBuffer = function(t2, e2) {
  return Ri(Qi, t2, { baseOptions: { modelAssetBuffer: e2 } });
