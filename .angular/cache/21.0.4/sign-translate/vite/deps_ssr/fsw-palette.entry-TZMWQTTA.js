...
var FswPalette = class {
  ...
  render() {
    return h(Host, { class: this.orientation + " " + this.size }, h("nav", null, h("fsw-button", { svg: HomeIcon, onClick: () => {
      this.group = null;
    } }), this.group ? h("fsw-button", { svg: ChevronUpIcon, onClick: () => {
      if (this.base) {
        this.base = null;
        this.more = null;
      } else {
    ...
    } }) : h("div", null), this.hasMore ? h("fsw-button", { svg: this.more ? ArrowLeftIcon : ArrowRightIcon, onClick: () => {
      this.more = !this.more;
    } }) : this.size == "small" ? h("div", null) : null, this.hasLower ? h("fsw-button", { svg: this.lower ? ArrowUpIcon : ArrowDownIcon, onClick: () => {
      this.lower = !this.lower;
    } }) : this.size != "large" ? h("div", null) : null), h("main", null, this.palette.map((key) => h("fsw-palette-symbol", { symbol: key }))));
  }
  get el() {
...
//# sourceMappingURL=fsw-palette.entry-TZMWQTTA.js.map
