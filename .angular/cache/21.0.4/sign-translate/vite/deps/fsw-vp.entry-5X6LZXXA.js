  ...
  render() {
    ...
    return h(Host, { vp: this.vp }, h("span", { class: "outside" }, h("span", { class: "middle" }, h("span", { class: "inside" }, this.items.map((item) => {
      ...
      if (item["segment"] == "sign") {
        ...
        return h("fsw-sign", { styling, style: { "font-size": values.zoom * 30 + "px", "width": width + "px", "height": height + "px", "margin-right": (right > 0 ? right : 0) + "px", "border-left": (right < 0 ? -right : 0) + "px solid transparent", "padding": padding + "px" } }, item["text"]);
        ...
        height = item["height"] * zoom + pad * 2;
        padding = Math.max(0, 20 * zoom - pad);
        return h("fsw-symbol", { styling, style: { "font-size": values.zoom * 30 + "px", "width": width + "px", "height": height + "px", "padding-bottom": padding + "px" } }, item["text"]);
      } else {
        console.log("other");
...
//# sourceMappingURL=fsw-vp.entry-5X6LZXXA.js.map
